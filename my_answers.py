...
#         self.activation_function = sigmoid
    ...
    def forward_pass_train(self, X):
        ...
        final_outputs = self.weights_hidden_to_output.T.dot(final_inputs) # signals from final output layer
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        delta_weights_i_h += self.lr * X.reshape(-1,1) * (hidden_error_term *  self.weights_hidden_to_output).T
    ...
    def update_weights(self, delta_weights_i_h, delta_weights_h_o, n_records):
        ...
        '''
        self.weights_hidden_to_output += (1/n_records) * delta_weights_h_o # update hidden-to-output weights with gradient descent step
    ...
    def run(self, features):
        ...
        if features.shape[0] == features.size:
